...
response.sendRedirect("http://localhost:8080/Online%20school%20registration%20system/form/admin.jsp");             
            ...
            {             
session.setAttribute("username",username);             
response.sendRedirect("http://localhost:8080/Online%20school%20registration%20system/form/student_info.jsp");    
            
            }    
       else if((username.equals("teacher") && password.equals("Teacher")))            
            {             
session.setAttribute("username",username);             
response.sendRedirect("http://localhost:8080/Online%20school%20registration%20system/form/teacher_info.jsp");    
...
response.sendRedirect("#");    
                ...
                response.sendRedirect("http://localhost:8080/Online%20school%20registration%20system/SignUP/index.html");        
            %>     
    </body> 
</html>